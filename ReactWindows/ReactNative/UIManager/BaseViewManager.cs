...
namespace ReactNative.UIManager
{
        ...
        where TLayoutShadowNode : LayoutShadowNode
    {
        ...
        /// </remarks>
        public override void OnDropViewInstance(ReactContext reactContext, TFrameworkElement view)
        {
        ...
        /// </remarks>
        protected override void AddEventEmitters(ReactContext reactContext, TFrameworkElement view)
        {
            view.PointerEntered += OnPointerEntered;
            view.PointerExited += OnPointerExited;
        }
